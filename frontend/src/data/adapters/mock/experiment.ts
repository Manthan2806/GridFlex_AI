...
const mockExperimentData: HorizonSimulationResult = {
  ...
  steps: [
    {
      ...
      resourceStates: [
        ...
        { resourceId: "industrial-batch-02", state: "DISPATCHED", dispatchedKw: 50, deliveredKw: 49 },
      ],
    },
    {
      stepNumber: 2,
    ...
    },
    {
      ...
      resourceStates: [
        ...
        { resourceId: "wh-building-a", state: "DISPATCHED", dispatchedKw: 40, deliveredKw: 38 },
        { resourceId: "industrial-batch-02", state: "DISPATCHED", dispatchedKw: 45, deliveredKw: 43 },
      ],
    },
    {
      stepNumber: 11,
      ...
      resourceStates: [
        ...
        { resourceId: "wh-building-a", state: "DISPATCHED", dispatchedKw: 40, deliveredKw: 38 },
        { resourceId: "industrial-batch-02", state: "DISPATCHED", dispatchedKw: 38, deliveredKw: 36 },
      ],
    },
    {
      stepNumber: 12,
      ...
      resourceStates: [
        ...
        { resourceId: "industrial-batch-02", state: "DISPATCHED", dispatchedKw: 34, deliveredKw: 32 },
      ],
    },
    {
      stepNumber: 13,
      ...
      resourceStates: [
        ...
        { resourceId: "industrial-batch-02", state: "DISPATCHED", dispatchedKw: 30, deliveredKw: 28 },
      ],
    },
    {
      stepNumber: 14,
      ...
      resourceStates: [
        ...
        { resourceId: "industrial-batch-02", state: "DISPATCHED", dispatchedKw: 25, deliveredKw: 22 },
      ],
    },
    {
      stepNumber: 15,
      ...
      resourceStates: [
        ...
        { resourceId: "industrial-batch-02", state: "DISPATCHED", dispatchedKw: 20, deliveredKw: 18 },
      ],
    },
    {
      stepNumber: 16,
      ...
      resourceStates: [
        ...
        { resourceId: "industrial-batch-02", state: "COMPLETED", dispatchedKw: 15, deliveredKw: 13 },
      ],
    },
  ],
  instructionMatrix: [
    ...
    {
      resourceId: "industrial-batch-02",
      ratedPowerKw: 200,
      requiredEnergyKwh: 1000,
      horizonState: "DISPATCHED",
      dispatchedKw: 660,
      deliveredKw: 631,
    },
  ...
  trustUpdates: [
    ...
    {
      resourceId: "industrial-batch-02",
      before: { overrideRate: 0.10, availabilityRate: 0.90, confidence: 0.75 },
      after: { overrideRate: 0.05, availabilityRate: 0.95, confidence: 0.88 },
      observedResponse: 51,
    },
  ],
