...
const dispatchData = {
  ...
  recommendedDispatch: {
    ...
    resources: [
      { id: "ev-fleet-01", name: "EV Fleet Charger 01", type: "ev", dispatchedKw: 120, state: "dispatched" },
      { id: "wh-building-a", name: "Water Heater Bank A", type: "water_heater", dispatchedKw: 85, state: "dispatched" },
      { id: "industrial-batch-02", name: "Industrial Batch 02", type: "industrial_batch", dispatchedKw: 180, state: "dispatched" },
    ],
