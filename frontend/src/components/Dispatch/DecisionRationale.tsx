  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <strong>Note:</strong> This dispatch plan is simulated in the UrjaSarathi environment and does not control physical devices. All decisions are based on historical data patterns and current system constraints.
        </div>
      </div>
    </section>
  )
